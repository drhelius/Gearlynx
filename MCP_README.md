...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>x64</td>
      <td><a href="https://github.com/drhelius/Gearlynx/releases/download/1.2.18/Gearlynx-1.2.18-mcpb-windows-x64.mcpb">Gearlynx-1.2.18-mcpb-windows-x64.mcpb</a></td>
    </tr>
    <tr>
      <td>ARM64</td>
      <td><a href="https://github.com/drhelius/Gearlynx/releases/download/1.2.18/Gearlynx-1.2.18-mcpb-windows-arm64.mcpb">Gearlynx-1.2.18-mcpb-windows-arm64.mcpb</a></td>
    </tr>
    <tr>
      <td rowspan="2"><strong>macOS</strong></td>
      <td>x64</td>
      <td><a href="https://github.com/drhelius/Gearlynx/releases/download/1.2.18/Gearlynx-1.2.18-mcpb-macos-x64.mcpb">Gearlynx-1.2.18-mcpb-macos-x64.mcpb</a></td>
    </tr>
    <tr>
      <td>ARM64</td>
      <td><a href="https://github.com/drhelius/Gearlynx/releases/download/1.2.18/Gearlynx-1.2.18-mcpb-macos-arm64.mcpb">Gearlynx-1.2.18-mcpb-macos-arm64.mcpb</a></td>
    </tr>
    <tr>
      <td rowspan="2"><strong>Linux</strong></td>
      <td>x64</td>
      <td><a href="https://github.com/drhelius/Gearlynx/releases/download/1.2.18/Gearlynx-1.2.18-mcpb-linux-x64.mcpb">Gearlynx-1.2.18-mcpb-linux-x64.mcpb</a></td>
    </tr>
    <tr>
      <td>ARM64</td>
      <td><a href="https://github.com/drhelius/Gearlynx/releases/download/1.2.18/Gearlynx-1.2.18-mcpb-linux-arm64.mcpb">Gearlynx-1.2.18-mcpb-linux-arm64.mcpb</a></td>
    </tr>
  </tbody>
</table>
...
1. **Start the emulator manually** with HTTP transport:
  ...
  ```bash
  ./gearlynx --mcp-http --mcp-http-address 1.2.188.1.50 --mcp-http-port 3000
  ```
...
2. **Optional: require bearer-token authentication**:
  ...
  Set `GEARLYNX_MCP_HTTP_TOKEN` before starting HTTP mode.
