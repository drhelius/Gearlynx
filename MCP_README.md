...
By default, Gearlynx exposes a compact set of high-frequency tools directly and routes advanced debugger tools through four discovery tools. This keeps MCP context small while preserving access to the full debugger surface.
