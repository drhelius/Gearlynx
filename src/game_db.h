...
const GLYNX_Game_DB_Entry k_game_database[] =
{
    ...
    { 0x97501709, "Centipede (USA) (Proto)", 131072, 0, 0, GLYNX_DB_FLAG_ROTATE_LEFT },
    ...
    { 0xAC564BAA, "Gauntlet - The Third Encounter (1990) [o1]", 262144, 0, 0, GLYNX_DB_FLAG_ROTATE_RIGHT },
    { 0x7F0EC7AD, "Gauntlet - The Third Encounter (USA, Europe)", 131072, 0, 0, GLYNX_DB_FLAG_ROTATE_RIGHT },
    { 0xDCD723E3, "Gauntlet - The Third Encounter (USA, Europe) (Beta) (1990-06-04)", 131072, GLYNX_DB_SIZE_C128K, 0, GLYNX_DB_FLAG_ROTATE_RIGHT },
    ...
    { 0xA53649F1, "Klax (USA, Europe)", 262144, 0, 0, GLYNX_DB_FLAG_ROTATE_RIGHT },
    { 0x4D5D94F4, "Klax (USA, Europe) (Beta)", 262144, 0, 0, GLYNX_DB_FLAG_ROTATE_RIGHT },
    ...
    { 0x0271B6E9, "Lexis (USA)", 262144, 0, 0, GLYNX_DB_FLAG_ROTATE_LEFT },
    ...
    { 0x006FD398, "NFL Football (USA, Europe)", 262144, 0, 0, GLYNX_DB_FLAG_ROTATE_LEFT },
    ...
    { 0xBCD10C3A, "Raiden (USA) (v3.0) (Beta)", 262144, 0, 0, GLYNX_DB_FLAG_ROTATE_LEFT},
    { 0x689F31A4, "Raiden (World) (Aftermarket) (Unl)", 524288, 0, 0, GLYNX_DB_FLAG_ROTATE_LEFT },
