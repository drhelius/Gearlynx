...
5. Common useful details are the Gearlynx version, whether the user is running the desktop app or RetroArch/libretro, the host platform, and relevant non-default configuration settings. Ask only for the items that matter to this report.
