    ...
    if (ImGui::BeginPopupModal("About " GLYNX_TITLE, NULL, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ...
        if (ImGui::BeginTabBar("##Tabs", ImGuiTabBarFlags_None))
        {
            if (ImGui::BeginTabItem("Build Info"))
            {
                ...
                ImGui::Text("Build: %s", GLYNX_VERSION);
                ...
                ImGui::Text("define: GLYNX_DEBUG");
                #endif
                #if defined(GLYNX_NO_OPTIMIZATIONS)
                ImGui::Text("define: GLYNX_NO_OPTIMIZATIONS");
                #endif
                ...
                ImGui::Text("define: GLYNX_LITTLE_ENDIAN");
                #endif
                #if defined(GLYNX_BIG_ENDIAN)
                ImGui::Text("define: GLYNX_BIG_ENDIAN");
                #endif
                ImGui::EndChild();
                ImGui::EndTabItem();
            }
